...
<body style="background:#fff;">
    ...
    <style> 
        ...
        .bricon
        {
            background: url(slider_assets/img/browser-icons.png);
        }
    </style>
    <!-- it works the same with all jquery version from 1.x to 2.x -->
    <script type="text/javascript" src="slider_assets/js/jquery-1.9.1.min.js"></script>
    <!-- use jssor.slider.mini.js (39KB) or jssor.sliderc.mini.js (31KB, with caption, no slideshow) or jssor.sliders.mini.js (26KB, no caption, no slideshow) instead for release -->
    <!-- jssor.slider.mini.js = jssor.sliderc.mini.js = jssor.sliders.mini.js = (jssor.core.js + jssor.utils.js + jssor.slider.js) -->
    <script type="text/javascript" src="slider_assets/js/jssor.core.js"></script>
    <script type="text/javascript" src="slider_assets/js/jssor.utils.js"></script>
    <script type="text/javascript" src="slider_assets/js/jssor.slider.js"></script>
    <script>
    ...
    <div id="slider2_container" style="position: relative; width: 1140px;
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background: url(slider_assets/img/loading.gif) no-repeat center center;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1140px; height: 300px;
            overflow: hidden;">
            <div>
                <a u=image href="http://www.jssor.com"><img src="slider_assets/img/images/1.jpg" /></a>
            </div>
            <div>
                <a u=image href="http://www.jssor.com"><img src="slider_assets/img/images/2.jpg" /></a>
            </div>
            <div>
                <a u=image href="http://www.jssor.com"><img src="slider_assets/img/images/3.jpg" /></a>
            </div>
        </div>
        ...
        <style>
            ...
            */
            .jssora05l, .jssora05r, .jssora05ldn, .jssora05rdn
            {
            	...
            	cursor: pointer;
            	display: block;
                background: url(slider_assets/img/a17.png) no-repeat;
                overflow:hidden;
            }
