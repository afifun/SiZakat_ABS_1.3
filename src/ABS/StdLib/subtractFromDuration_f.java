...
public final class subtractFromDuration_f implements abs.backend.java.lib.types.ABSFunction {
    ...
    public static ABS.StdLib.Duration apply(ABS.StdLib.Duration d, abs.backend.java.lib.types.ABSRational v) {
        return new abs.backend.java.lib.expr.Case() {
            public ABS.StdLib.Duration of(final abs.backend.java.lib.types.ABSRational v, final ABS.StdLib.Duration d, final ABS.StdLib.Duration __ABS_value) {
                ...
                throw new abs.backend.java.lib.expr.UnmatchedCaseException("abslang.abs:368:3:  value " + __ABS_value + " did not match any pattern.");
            }
        }.of(v, d, d);
    }
}
