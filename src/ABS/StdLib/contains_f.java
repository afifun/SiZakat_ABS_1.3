...
public final class contains_f implements abs.backend.java.lib.types.ABSFunction {
    ...
    public static <A extends abs.backend.java.lib.types.ABSValue>abs.backend.java.lib.types.ABSBool apply(ABS.StdLib.Set<A> ss, A e) {
        return new abs.backend.java.lib.expr.Case() {
            public abs.backend.java.lib.types.ABSBool of(final A e, final ABS.StdLib.Set<A> ss, final ABS.StdLib.Set<A> __ABS_value) {
                ...
                final abs.backend.java.lib.expr.PatternBinding __ABS_binding2 = new abs.backend.java.lib.expr.PatternConstructor(ABS.StdLib.Set_Insert.class,new abs.backend.java.lib.expr.AnyPattern(),new abs.backend.java.lib.expr.PatternVariable("xs")).match(__ABS_value);
                if (__ABS_binding2 != null) return new Object() {
                    public abs.backend.java.lib.types.ABSBool execute(final ABS.StdLib.Set<A> xs) { return ABS.StdLib.contains_f.apply(xs, e); }
                }.execute((ABS.StdLib.Set<A>) __ABS_binding2.getBinding(0));
                throw new abs.backend.java.lib.expr.UnmatchedCaseException("abslang.abs:53:3:  value " + __ABS_value + " did not match any pattern.");
            }
        }.of(e, ss, ss);
    }
}
