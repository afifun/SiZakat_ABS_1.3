        ...
        return new abs.backend.java.lib.expr.Case() {
            public ABS.StdLib.Set<A> of(final ABS.StdLib.List<A> l, final ABS.StdLib.List<A> __ABS_value) {
                ...
                if (__ABS_binding1 != null) return new Object() {
                    public ABS.StdLib.Set<A> execute(final A x, final ABS.StdLib.List<A> xs) { return new ABS.StdLib.Set_Insert(x, ABS.StdLib.set_f.apply(xs)); }
                }.execute((A) __ABS_binding1.getBinding(0),(ABS.StdLib.List<A>) __ABS_binding1.getBinding(1));
                throw new abs.backend.java.lib.expr.UnmatchedCaseException("abslang.abs:44:5:  value " + __ABS_value + " did not match any pattern.");
            }
        }.of(l, l);
    }
}
