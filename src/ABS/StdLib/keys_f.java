        ...
        return new abs.backend.java.lib.expr.Case() {
            public ABS.StdLib.Set<A> of(final ABS.StdLib.Map<A,B> map, final ABS.StdLib.Map<A,B> __ABS_value) {
                ...
                if (__ABS_binding1 != null) return new Object() {
                    public ABS.StdLib.Set<A> execute(final A a, final ABS.StdLib.Map<A,B> tail) { return new ABS.StdLib.Set_Insert(a, ABS.StdLib.keys_f.apply(tail)); }
                }.execute((A) __ABS_binding1.getBinding(0),(ABS.StdLib.Map<A,B>) __ABS_binding1.getBinding(1));
                throw new abs.backend.java.lib.expr.UnmatchedCaseException("abslang.abs:218:3:  value " + __ABS_value + " did not match any pattern.");
            }
        }.of(map, map);
    }
}
