...
public final class nth_f implements abs.backend.java.lib.types.ABSFunction {
    ...
    public static <A extends abs.backend.java.lib.types.ABSValue>A apply(ABS.StdLib.List<A> list, abs.backend.java.lib.types.ABSInteger n) {
        return new abs.backend.java.lib.expr.Case() {
            public A of(final abs.backend.java.lib.types.ABSInteger n, final ABS.StdLib.List<A> list, final abs.backend.java.lib.types.ABSInteger __ABS_value) {
                ...
                throw new abs.backend.java.lib.expr.UnmatchedCaseException("abslang.abs:141:3:  value " + __ABS_value + " did not match any pattern.");
            }
        }.of(n, list, n);
    }
}
